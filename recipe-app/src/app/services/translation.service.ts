...
export class TranslationService {
  ...
  private baseTranslations: { [key: string]: string } = {
    ...
    meal_drop_here: 'Drop recipe here',
    meal_add_recipe: 'Add Recipe',
    meal_search_placeholder: 'Search recipes...',
    meal_select_recipe: 'Select a Recipe',
    meal_no_recipes: 'No recipes available',
    ...
    import_url_hint: 'Paste a link from Cookpad, Instagram, Pinterest, or any recipe blog',
    import_url_placeholder: 'https://www.cookpad.com/recipe/...',
    import_button: 'Import Recipe',
    importing: 'Importing...',
    supported_sites: 'Supported Sites',
    recipe_title: 'Recipe Title',
    recipe_title_placeholder: 'e.g., Classic Paella',
    recipe_ingredients: 'Ingredients',
    ingredients_hint: 'One per line with quantities (e.g., 200g rice)',
    ingredients_placeholder: '200g rice\n400ml chicken broth\n100g chicken\n50g peas\n1 onion, diced',
    recipe_instructions: 'Instructions',
    instructions_hint: 'One step per line',
    instructions_placeholder: '1. Heat oil in pan\n2. Sauté onion until golden\n3. Add rice and broth\n4. Cook for 20 minutes',
    create_recipe: 'Create Recipe',
    import_scan_label: 'Scan Recipe from Book',
    import_scan_hint: 'Take a photo of a recipe from a cookbook or magazine',
    tap_to_scan: 'Tap to capture photo',
    analyzing_image: 'Analyzing image...',
    preview_recipe: 'Review Recipe',
    high_confidence: 'High Quality',
    medium_confidence: 'Needs Review',
    low_confidence: 'Verify Info',
    recipe_description: 'Description',
    back: 'Back',
    saving: 'Saving...',
    save_recipe: 'Save Recipe',
    recipe_imported_success: 'Recipe imported successfully!',
  ...
  private fallbackTranslations: Translations = {
    ...
    meal_breakfast: { en: 'Breakfast', es: 'Desayuno', fr: 'Petit-déjeuner', de: 'Frühstück', it: 'Colazione' },
    meal_lunch: { en: 'Lunch', es: 'Comida', fr: 'Déjeuner', de: 'Mittagessen', it: 'Pranzo' },
    meal_dinner: { en: 'Dinner', es: 'Cena', fr: 'Dîner', de: 'Abendessen', it: 'Cena' },
    meal_servings: { en: 'servings', es: 'porciones', fr: 'portions', de: 'Portionen', it: 'porzioni' },
    meal_drop_here: { en: 'Drop recipe here', es: 'Arrastra receta aquí', fr: 'Déposer recette ici', de: 'Rezept hier ablegen', it: 'Rilascia ricetta qui' },
    meal_add_recipe: { en: 'Add Recipe', es: 'Agregar Receta', fr: 'Ajouter Recette', de: 'Rezept Hinzufügen', it: 'Aggiungi Ricetta' },
    meal_search_placeholder: { en: 'Search recipes...', es: 'Buscar recetas...', fr: 'Rechercher recettes...', de: 'Rezepte suchen...', it: 'Cerca ricette...' },
    meal_select_recipe: { en: 'Select a Recipe', es: 'Selecciona una Receta', fr: 'Sélectionner une Recette', de: 'Rezept Auswählen', it: 'Seleziona una Ricetta' },
    meal_no_recipes: { en: 'No recipes available', es: 'No hay recetas disponibles', fr: 'Aucune recette disponible', de: 'Keine Rezepte verfügbar', it: 'Nessuna ricetta disponibile' },
    ...
    import_recipe_title: { en: 'Import Recipe', es: 'Importar Receta', fr: 'Importer Recette', de: 'Rezept Importieren', it: 'Importa Ricetta' },
    import_from_url: { en: 'From URL', es: 'Desde URL', fr: 'Depuis URL', de: 'Von URL', it: 'Da URL' },
    import_manual: { en: 'Manual', es: 'Manual', fr: 'Manuel', de: 'Manuell', it: 'Manuale' },
    import_scan: { en: 'Scan', es: 'Escanear', fr: 'Scanner', de: 'Scannen', it: 'Scansiona' },
    import_url_label: { en: 'Recipe URL', es: 'URL de Receta', fr: 'URL de Recette', de: 'Rezept-URL', it: 'URL Ricetta' },
    import_url_hint: { en: 'Paste a link from Cookpad, Instagram, Pinterest, or any recipe blog', es: 'Pega un enlace de Cookpad, Instagram, Pinterest o cualquier blog de recetas', fr: 'Collez un lien de Cookpad, Instagram, Pinterest ou tout blog de recettes', de: 'Link von Cookpad, Instagram, Pinterest oder einem Rezeptblog einfügen', it: 'Incolla un link da Cookpad, Instagram, Pinterest o qualsiasi blog di ricette' },
    import_url_placeholder: { en: 'https://www.cookpad.com/recipe/...', es: 'https://www.cookpad.com/receta/...', fr: 'https://www.cookpad.com/recette/...', de: 'https://www.cookpad.com/rezept/...', it: 'https://www.cookpad.com/ricetta/...' },
    import_button: { en: 'Import Recipe', es: 'Importar Receta', fr: 'Importer Recette', de: 'Rezept Importieren', it: 'Importa Ricetta' },
    importing: { en: 'Importing...', es: 'Importando...', fr: 'Importation...', de: 'Importieren...', it: 'Importazione...' },
    supported_sites: { en: 'Supported Sites', es: 'Sitios Soportados', fr: 'Sites Pris en Charge', de: 'Unterstützte Seiten', it: 'Siti Supportati' },
    recipe_title: { en: 'Recipe Title', es: 'Título de Receta', fr: 'Titre de Recette', de: 'Rezepttitel', it: 'Titolo Ricetta' },
    recipe_title_placeholder: { en: 'e.g., Classic Paella', es: 'ej., Paella Clásica', fr: 'ex., Paella Classique', de: 'z.B., Klassische Paella', it: 'es., Paella Classica' },
    recipe_ingredients: { en: 'Ingredients', es: 'Ingredientes', fr: 'Ingrédients', de: 'Zutaten', it: 'Ingredienti' },
    ingredients_hint: { en: 'One per line with quantities (e.g., 200g rice)', es: 'Uno por línea con cantidades (ej., 200g arroz)', fr: 'Un par ligne avec quantités (ex., 200g riz)', de: 'Eins pro Zeile mit Mengen (z.B., 200g Reis)', it: 'Uno per riga con quantità (es., 200g riso)' },
    ingredients_placeholder: { en: '200g rice\n400ml chicken broth\n100g chicken\n50g peas\n1 onion, diced', es: '200g arroz\n400ml caldo de pollo\n100g pollo\n50g guisantes\n1 cebolla picada', fr: '200g riz\n400ml bouillon de poulet\n100g poulet\n50g petits pois\n1 oignon haché', de: '200g Reis\n400ml Hühnerbrühe\n100g Hühnchen\n50g Erbsen\n1 Zwiebel, gewürfelt', it: '200g riso\n400ml brodo di pollo\n100g pollo\n50g piselli\n1 cipolla a dadini' },
    recipe_instructions: { en: 'Instructions', es: 'Instrucciones', fr: 'Instructions', de: 'Anweisungen', it: 'Istruzioni' },
    instructions_hint: { en: 'One step per line', es: 'Un paso por línea', fr: 'Une étape par ligne', de: 'Ein Schritt pro Zeile', it: 'Un passo per riga' },
    instructions_placeholder: { en: '1. Heat oil in pan\n2. Sauté onion until golden\n3. Add rice and broth\n4. Cook for 20 minutes', es: '1. Calentar aceite en sartén\n2. Sofreír cebolla hasta dorar\n3. Añadir arroz y caldo\n4. Cocinar 20 minutos', fr: '1. Chauffer l\'huile dans la poêle\n2. Faire revenir l\'oignon jusqu\'à ce qu\'il soit doré\n3. Ajouter le riz et le bouillon\n4. Cuire pendant 20 minutes', de: '1. Öl in der Pfanne erhitzen\n2. Zwiebel goldbraun anbraten\n3. Reis und Brühe hinzufügen\n4. 20 Minuten kochen', it: '1. Scaldare l\'olio in padella\n2. Soffriggere la cipolla fino a doratura\n3. Aggiungere riso e brodo\n4. Cuocere per 20 minuti' },
    create_recipe: { en: 'Create Recipe', es: 'Crear Receta', fr: 'Créer Recette', de: 'Rezept Erstellen', it: 'Crea Ricetta' },
    import_scan_label: { en: 'Scan Recipe from Book', es: 'Escanear Receta de Libro', fr: 'Scanner Recette du Livre', de: 'Rezept aus Buch Scannen', it: 'Scansiona Ricetta da Libro' },
    import_scan_hint: { en: 'Take a photo of a recipe from a cookbook or magazine', es: 'Toma una foto de una receta de un libro o revista de cocina', fr: 'Prenez une photo d\'une recette d\'un livre ou magazine de cuisine', de: 'Foto eines Rezepts aus einem Kochbuch oder Magazin aufnehmen', it: 'Scatta una foto di una ricetta da un libro o rivista di cucina' },
    tap_to_scan: { en: 'Tap to capture photo', es: 'Toca para capturar foto', fr: 'Appuyez pour capturer la photo', de: 'Tippen um Foto aufzunehmen', it: 'Tocca per scattare foto' },
    analyzing_image: { en: 'Analyzing image...', es: 'Analizando imagen...', fr: 'Analyse de l\'image...', de: 'Bild wird analysiert...', it: 'Analisi immagine...' },
    preview_recipe: { en: 'Review Recipe', es: 'Revisar Receta', fr: 'Examiner Recette', de: 'Rezept Überprüfen', it: 'Rivedi Ricetta' },
    high_confidence: { en: 'High Quality', es: 'Alta Calidad', fr: 'Haute Qualité', de: 'Hohe Qualität', it: 'Alta Qualità' },
    medium_confidence: { en: 'Needs Review', es: 'Necesita Revisión', fr: 'À Réviser', de: 'Überprüfung Erforderlich', it: 'Da Rivedere' },
    low_confidence: { en: 'Verify Info', es: 'Verificar Info', fr: 'Vérifier Info', de: 'Info Prüfen', it: 'Verifica Info' },
    recipe_description: { en: 'Description', es: 'Descripción', fr: 'Description', de: 'Beschreibung', it: 'Descrizione' },
    back: { en: 'Back', es: 'Atrás', fr: 'Retour', de: 'Zurück', it: 'Indietro' },
    saving: { en: 'Saving...', es: 'Guardando...', fr: 'Enregistrement...', de: 'Speichern...', it: 'Salvataggio...' },
    save_recipe: { en: 'Save Recipe', es: 'Guardar Receta', fr: 'Sauvegarder Recette', de: 'Rezept Speichern', it: 'Salva Ricetta' },
    recipe_imported_success: { en: 'Recipe imported successfully!', es: '¡Receta importada con éxito!', fr: 'Recette importée avec succès!', de: 'Rezept erfolgreich importiert!', it: 'Ricetta importata con successo!' },
    ...
    generate_shopping_list: { en: 'Generate Shopping List', es: 'Generar Lista de Compras', fr: 'Générer Liste de Courses', de: 'Einkaufsliste Generieren', it: 'Genera Lista Spesa' },
    shopping_list_generated: { en: 'Shopping list generated!', es: '¡Lista de compras generada!', fr: 'Liste de courses générée!', de: 'Einkaufsliste generiert!', it: 'Lista spesa generata!' },
    items_added: { en: 'items added', es: 'artículos agregados', fr: 'articles ajoutés', de: 'Artikel hinzugefügt', it: 'articoli aggiunti' },
    items_completed: { en: 'items completed', es: 'artículos completados', fr: 'articles terminés', de: 'Artikel erledigt', it: 'articoli completati' },
    category_dairy: { en: 'Dairy', es: 'Lácteos', fr: 'Produits Laitiers', de: 'Milchprodukte', it: 'Latticini' },
    category_fruits_vegetables: { en: 'Fruits & Vegetables', es: 'Frutas y Verduras', fr: 'Fruits et Légumes', de: 'Obst & Gemüse', it: 'Frutta e Verdura' },
    category_meat_fish: { en: 'Meat & Fish', es: 'Carnes y Pescados', fr: 'Viande et Poisson', de: 'Fleisch & Fisch', it: 'Carne e Pesce' },
    category_pantry: { en: 'Pantry', es: 'Despensa', fr: 'Garde-Manger', de: 'Vorratskammer', it: 'Dispensa' },
    category_spices: { en: 'Spices & Condiments', es: 'Especias y Condimentos', fr: 'Épices et Condiments', de: 'Gewürze & Würzmittel', it: 'Spezie e Condimenti' },
    category_frozen: { en: 'Frozen', es: 'Congelados', fr: 'Surgelés', de: 'Tiefkühl', it: 'Surgelati' },
    category_bakery: { en: 'Bakery', es: 'Panadería', fr: 'Boulangerie', de: 'Bäckerei', it: 'Panetteria' },
    category_other: { en: 'Other', es: 'Otros', fr: 'Autres', de: 'Sonstiges', it: 'Altro' },
    view_by_category: { en: 'By Category', es: 'Por Categoría', fr: 'Par Catégorie', de: 'Nach Kategorie', it: 'Per Categoria' },
    view_list: { en: 'List View', es: 'Vista Lista', fr: 'Vue Liste', de: 'Listenansicht', it: 'Vista Elenco' },
    hide_checked: { en: 'Hide Checked', es: 'Ocultar Marcados', fr: 'Masquer Cochés', de: 'Erledigte Ausblenden', it: 'Nascondi Spuntati' },
    add_item: { en: 'Add Item', es: 'Agregar Artículo', fr: 'Ajouter Article', de: 'Artikel Hinzufügen', it: 'Aggiungi Articolo' },
    item_name: { en: 'Item Name', es: 'Nombre del Artículo', fr: 'Nom de l\'Article', de: 'Artikelname', it: 'Nome Articolo' },
    item_name_placeholder: { en: 'e.g., Milk, Bread, Eggs...', es: 'ej., Leche, Pan, Huevos...', fr: 'ex., Lait, Pain, Œufs...', de: 'z.B., Milch, Brot, Eier...', it: 'es., Latte, Pane, Uova...' },
    category: { en: 'Category', es: 'Categoría', fr: 'Catégorie', de: 'Kategorie', it: 'Categoria' },
    add: { en: 'Add', es: 'Agregar', fr: 'Ajouter', de: 'Hinzufügen', it: 'Aggiungi' },
    remove: { en: 'Remove', es: 'Eliminar', fr: 'Supprimer', de: 'Entfernen', it: 'Rimuovi' },
    adjust_servings_global: { en: 'Adjust for Number of People', es: 'Ajustar para Cantidad de Personas', fr: 'Ajuster pour Nombre de Personnes', de: 'Für Personenzahl Anpassen', it: 'Regola per Numero Persone' },
    multiplier_description: { en: 'Adjust all quantities based on the number of people you\'re shopping for.', es: 'Ajusta todas las cantidades según el número de personas para las que compras.', fr: 'Ajustez toutes les quantités en fonction du nombre de personnes.', de: 'Passen Sie alle Mengen an die Anzahl der Personen an.', it: 'Regola tutte le quantità in base al numero di persone.' },
    number_of_people: { en: 'Number of People', es: 'Cantidad de Personas', fr: 'Nombre de Personnes', de: 'Anzahl Personen', it: 'Numero Persone' },
    multiplier_hint: { en: 'All quantities will be multiplied by this number', es: 'Todas las cantidades se multiplicarán por este número', fr: 'Toutes les quantités seront multipliées par ce nombre', de: 'Alle Mengen werden mit dieser Zahl multipliziert', it: 'Tutte le quantità verranno moltiplicate per questo numero' },
    apply: { en: 'Apply', es: 'Aplicar', fr: 'Appliquer', de: 'Anwenden', it: 'Applica' },
    copied_to_clipboard: { en: 'Copied to clipboard!', es: '¡Copiado al portapapeles!', fr: 'Copié dans le presse-papiers!', de: 'In Zwischenablage kopiert!', it: 'Copiato negli appunti!' },
    copy_failed: { en: 'Copy failed', es: 'Error al copiar', fr: 'Échec de la copie', de: 'Kopieren fehlgeschlagen', it: 'Copia fallita' },
    share_whatsapp: { en: 'Share via WhatsApp', es: 'Compartir por WhatsApp', fr: 'Partager via WhatsApp', de: 'Via WhatsApp Teilen', it: 'Condividi via WhatsApp' },
    share_email: { en: 'Share via Email', es: 'Compartir por Email', fr: 'Partager par Email', de: 'Per E-Mail Teilen', it: 'Condividi via Email' },
    print: { en: 'Print List', es: 'Imprimir Lista', fr: 'Imprimer Liste', de: 'Liste Drucken', it: 'Stampa Lista' },
    dark_mode: { en: 'Dark Mode', es: 'Modo Oscuro', fr: 'Mode Sombre', de: 'Dunkelmodus', it: 'Modalità Scura' },
    shopping_empty_hint: { en: 'Add items manually or generate from your meal plan', es: 'Agrega artículos manualmente o genera desde tu planificador', fr: 'Ajoutez des articles manuellement ou générez depuis votre plan de repas', de: 'Fügen Sie Artikel manuell hinzu oder generieren Sie aus Ihrem Essensplan', it: 'Aggiungi articoli manualmente o genera dal tuo piano pasti' },
    from_recipe: { en: 'From Recipe', es: 'De Receta', fr: 'De Recette', de: 'Vom Rezept', it: 'Dalla Ricetta' },
    clear_checked: { en: 'Clear Checked', es: 'Limpiar Marcados', fr: 'Effacer Cochés', de: 'Erledigte Löschen', it: 'Cancella Spuntati' },
    quantities_adjusted: { en: 'Quantities adjusted', es: 'Cantidades ajustadas', fr: 'Quantités ajustées', de: 'Mengen angepasst', it: 'Quantità regolate' },
    checked_items_cleared: { en: 'Checked items cleared', es: 'Artículos marcados eliminados', fr: 'Articles cochés supprimés', de: 'Erledigte Artikel gelöscht', it: 'Articoli spuntati cancellati' },
    item_removed: { en: 'Item removed', es: 'Artículo eliminado', fr: 'Article supprimé', de: 'Artikel entfernt', it: 'Articolo rimosso' },
    item_added: { en: 'Item added', es: 'Artículo agregado', fr: 'Article ajouté', de: 'Artikel hinzugefügt', it: 'Articolo aggiunto' },
    fridge_tab_search: { en: 'Search Recipes', es: 'Buscar Recetas', fr: 'Rechercher Recettes', de: 'Rezepte Suchen', it: 'Cerca Ricette' },
    fridge_tab_pantry: { en: 'My Pantry', es: 'Mi Despensa', fr: 'Mon Garde-Manger', de: 'Meine Vorratskammer', it: 'La Mia Dispensa' },
    pantry_title: { en: 'My Pantry', es: 'Mi Despensa', fr: 'Mon Garde-Manger', de: 'Meine Vorratskammer', it: 'La Mia Dispensa' },
    pantry_add_item: { en: 'Add Item', es: 'Agregar Artículo', fr: 'Ajouter Article', de: 'Artikel Hinzufügen', it: 'Aggiungi Articolo' },
    pantry_add_new_item: { en: 'Add New Item', es: 'Agregar Nuevo Artículo', fr: 'Ajouter Nouvel Article', de: 'Neuen Artikel Hinzufügen', it: 'Aggiungi Nuovo Articolo' },
    pantry_item_name: { en: 'Item Name', es: 'Nombre del Artículo', fr: 'Nom de l\'Article', de: 'Artikelname', it: 'Nome Articolo' },
    pantry_item_name_placeholder: { en: 'e.g., Tomatoes, Milk, Rice...', es: 'ej., Tomates, Leche, Arroz...', fr: 'ex., Tomates, Lait, Riz...', de: 'z.B., Tomaten, Milch, Reis...', it: 'es., Pomodori, Latte, Riso...' },
    pantry_quantity: { en: 'Quantity', es: 'Cantidad', fr: 'Quantité', de: 'Menge', it: 'Quantità' },
    pantry_unit: { en: 'Unit (g, kg, L, pieces...)', es: 'Unidad (g, kg, L, piezas...)', fr: 'Unité (g, kg, L, pièces...)', de: 'Einheit (g, kg, L, Stück...)', it: 'Unità (g, kg, L, pezzi...)' },
    pantry_expiry_date: { en: 'Expiry Date (optional)', es: 'Fecha de Caducidad (opcional)', fr: 'Date d\'Expiration (optionnel)', de: 'Verfallsdatum (optional)', it: 'Data di Scadenza (opzionale)' },
    pantry_category_fresh: { en: 'Fresh', es: 'Frescos', fr: 'Frais', de: 'Frisch', it: 'Fresco' },
    pantry_category_frozen: { en: 'Frozen', es: 'Congelados', fr: 'Surgelés', de: 'Tiefkühl', it: 'Surgelati' },
    pantry_category_pantry: { en: 'Pantry', es: 'Despensa', fr: 'Garde-Manger', de: 'Vorrat', it: 'Dispensa' },
    pantry_category_dairy: { en: 'Dairy', es: 'Lácteos', fr: 'Produits Laitiers', de: 'Milchprodukte', it: 'Latticini' },
    pantry_category_spices: { en: 'Spices', es: 'Especias', fr: 'Épices', de: 'Gewürze', it: 'Spezie' },
    pantry_category_beverages: { en: 'Beverages', es: 'Bebidas', fr: 'Boissons', de: 'Getränke', it: 'Bevande' },
    pantry_category_other: { en: 'Other', es: 'Otros', fr: 'Autres', de: 'Sonstiges', it: 'Altro' },
    pantry_expiry_alerts: { en: 'Expiring Soon', es: 'Próximos a Caducar', fr: 'Expire Bientôt', de: 'Läuft Bald Ab', it: 'In Scadenza' },
    pantry_expires_today: { en: 'Expires today!', es: '¡Caduca hoy!', fr: 'Expire aujourd\'hui!', de: 'Läuft heute ab!', it: 'Scade oggi!' },
    pantry_expires_tomorrow: { en: 'Expires tomorrow', es: 'Caduca mañana', fr: 'Expire demain', de: 'Läuft morgen ab', it: 'Scade domani' },
    pantry_expires_in: { en: 'Expires in', es: 'Caduca en', fr: 'Expire dans', de: 'Läuft ab in', it: 'Scade tra' },
    days: { en: 'days', es: 'días', fr: 'jours', de: 'Tagen', it: 'giorni' },
    pantry_empty: { en: 'Your pantry is empty', es: 'Tu despensa está vacía', fr: 'Votre garde-manger est vide', de: 'Ihre Vorratskammer ist leer', it: 'La tua dispensa è vuota' },
    pantry_empty_hint: { en: 'Start adding items to track your inventory and reduce waste', es: 'Comienza a agregar artículos para rastrear tu inventario y reducir el desperdicio', fr: 'Commencez à ajouter des articles pour suivre votre inventaire et réduire le gaspillage', de: 'Beginnen Sie Artikel hinzuzufügen, um Ihr Inventar zu verfolgen und Verschwendung zu reduzieren', it: 'Inizia ad aggiungere articoli per monitorare il tuo inventario e ridurre gli sprechi' },
    pantry_used: { en: 'Used', es: 'Usado', fr: 'Utilisé', de: 'Verwendet', it: 'Usato' },
    pantry_item_added: { en: 'Item added to pantry', es: 'Artículo agregado a la despensa', fr: 'Article ajouté au garde-manger', de: 'Artikel zur Vorratskammer hinzugefügt', it: 'Articolo aggiunto alla dispensa' },
    pantry_item_removed: { en: 'Item removed from pantry', es: 'Artículo eliminado de la despensa', fr: 'Article supprimé du garde-manger', de: 'Artikel aus Vorratskammer entfernt', it: 'Articolo rimosso dalla dispensa' },
    already_have: { en: 'Already have', es: 'Ya tienes', fr: 'Vous avez déjà', de: 'Sie haben bereits', it: 'Hai già' },
    need_more: { en: 'need', es: 'necesitas', fr: 'besoin de', de: 'benötigen', it: 'hai bisogno di' },
    enough_in_pantry: { en: 'Enough in pantry', es: 'Suficiente en despensa', fr: 'Assez dans le garde-manger', de: 'Genug in Vorratskammer', it: 'Sufficiente in dispensa' }
  };
